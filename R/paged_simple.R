#' Function for IOM paged simple template
#'
...
paged_simple <- function(back_html = TRUE,
                         ...
                         ...) {
  # base css files
  base_css <- iomdesign::use_iom_css(c("reset", "color_variables", "fonts"))

  # logo css file
  logo_var <- paste0("  --iom-logoblue: url(\"", iomdesign::use_iom_logo(logo = "blue", data_uri = TRUE), "\");")
